...
function UncondensedDashboard(props: {
  open: boolean;
  setOpen: any;
  ...
  const calculateAverage = (start: number) => {
    ...
    const sum = data
      .slice(start, start + 7)
      .reduce((acc, curr) => acc + curr, initVal);
  ...
  useEffect(() => {
    ...
    else if (props.selectedModal === "Distance Travelled")
      setData(modalData[3]);
    else setData([]);
  }, [props.selectedModal]);
            ...
            <div>
              ...
              >
                <TextField
                  ...
                  onChange={(e) => {
                    handleTextFieldUpdate(parseInt(e.target.value));
                  }}
                />
              </Box>
              <Box
            ...
            <div>
              ...
              >
                ...
                <Typography variant="subtitle1" sx={{ paddingTop: 1 }}>
                  Average: {avgSteps} {props.selectedModal}
                </Typography>
                <Box padding={2}>
                ...
                <Box paddingTop={1} paddingBottom={4}>
                  <Typography variant="h6">
                    {getSteps(stepIndex)} {props.selectedModal}
                  </Typography>
                </Box>
                <Button
                  variant="contained"
                  onClick={() => {
                    setIsUpdateManually(true);
                  }}
                >
                  Update Manually
                </Button>
